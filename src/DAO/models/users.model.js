...
const userSchema = new Schema(
  {
    ...
    cartID: { type: String, required: false, ref: 'carts' },
    profileImage: { type: String, default: '/userNotLog.png' },
    documents: { type: Array, default: [{ name: '', link: '', status: 'pending', statusVerified: false, documentType: '' }] },
